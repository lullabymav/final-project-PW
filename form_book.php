    ...
    <div class="container p-5 d-flex justify-content-center">
        <div class="box p-5 pb-4" style="background-color: #e0cbaf; min-width: min-content; min-height: min-content; border-radius: 5%">
            <div class="boxContent">
                <h1 class="text-center" style="text-shadow: 2px 2px 3px white; font-size: 50px">Book Room</h1>
                <form action="process_book.php" method="POST">
                    <div class="input pt-3" style="font-size: 20px;"> 
                        ...
                        <input class="mb-3 mt-1 p-2 rounded shadow-sm" name="phone" style="width: 430px; border: none;" placeholder="08xxxxxxxxxx"><br>
                        ...
                        <label for="nigths">How Many Nights</label><br>
